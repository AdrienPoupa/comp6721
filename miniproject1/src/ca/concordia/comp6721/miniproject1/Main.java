...
public class Main {
    ...
    private static boolean solveDFS(Puzzle puzzle) {
        ...
        if (solved) {
            ...
            System.out.println("Number of moves: "+FileUtil.countLines("./miniproject1/results/puzzle"+solver.toString()+".txt"));
        } else {
    ...
    private static boolean solve(Puzzle puzzle, Solver solver, Heuristic heuristic) {
        ...
        if (solved) {
            System.out.println("The puzzle has been solved! Please have a look at the /miniproject1/results/puzzle"+filename+".txt file.");
            System.out.println("Number of moves: "+FileUtil.countLines("./miniproject1/results/puzzle"+filename+".txt"));
        } else {
